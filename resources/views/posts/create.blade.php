        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
					<!-- 
					--- mengarahkan action ke route yang bernama posts.store 
					--- route akan memanggil method di controller yang bernama store
					-->
...
<!-- Tips ! 
melakukan initialisasi Rich Text Editor menggunakan CKEDITOR yang akan di terapkan di dalam textarea yang diberi nama content
-->
<script>
